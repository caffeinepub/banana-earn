...
export class Backend implements backendInterface {
    ...
    async createTask(arg0: TaskId, arg1: string, arg2: string, arg3: number): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllTasksByReward(): Promise<Array<Task>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllTasksByReward();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async requestWithdrawal(arg0: number): Promise<void> {
        if (this.processError) {
            try {
    ...
    async seedChunkTasks(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.seedChunkTasks();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
